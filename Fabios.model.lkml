...
view: pageviews {
  derived_table: {
    sql:
     SELECT CAST('2017-01-01' as date) as pv_date, 1 as product_id
     UNION ALL
     SELECT CAST('2017-01-15' as date) as pv_date, 2 as product_id
     UNION ALL
     SELECT CAST('2017-01-24' as date) as pv_date, 2 as product_id
     UNION ALL
     SELECT CAST('2017-02-01' as date) as pv_date, 1 as product_id
     UNION ALL
     SELECT CAST('2017-02-01' as date) as pv_date, 3 as product_id
     UNION ALL
     SELECT CAST('2017-02-01' as date) as pv_date, NULL as product_id
     UNION ALL
     SELECT CAST('2017-02-21' as date) as pv_date, 2 as product_id
     UNION ALL
     SELECT CAST('2017-03-01' as date) as pv_date, 3 as product_id
     UNION ALL
     SELECT CAST('2017-03-01' as date) as pv_date, NULL as product_id
     UNION ALL
     SELECT CAST('2017-03-15' as date) as pv_date, 2 as product_id
    ;;
  }
...
view: orders {
  derived_table: {
    sql:
     SELECT CAST('2017-01-01' as date) as order_date, 1 as product_id, 200 as sale_price
     UNION ALL
     SELECT CAST('2017-02-01' as date) as order_date, 3 as product_id, 1000 as sale_price
     UNION ALL
     SELECT CAST('2017-02-21' as date) as order_date, 2 as product_id, 25 as sale_price
     UNION ALL
     SELECT CAST('2017-03-15' as date) as order_date, 2 as product_id, 50 as sale_price
    ;;
  }
